...
const dict = {
  ...
  'The minimum funding that we require in order to activate our contribution policy to the v2 open.  <b>Default: 10000</b>': 202,
  'Maximum Their Funding': 203,
  'The maximum funding that we will consider to activate our contribution policy to the v2 open. Any channel open above this will not be funded.  <b>Default: No max</b>': 204,
  'Per-Channel Minimum': 205,
  'The minimum amount that we will contribute to a channel open.  <b>Default: 10000</b>': 206,
  'Per-Channel Maximum': 207,
  'The maximum amount that we will contribute to a channel open.  <b>Default: No max</b>': 208,
  'Reserve Tank': 209,
  'The amount to leave available in the node wallet.  <b>Default: Nothing (can use all on-chain funds)</b>': 210,
  ...
  'Any amount': 279,
  'Payment hash': 280,
  'Amountless invoice to ${destination}; enter the amount below.': 281,
  'Invoice details: ${amount} sats to ${destination}.': 282,
  'I verified the amount and destination': 283,
  'Confirm these details before sending. Lightning payments cannot be reversed.': 284,
  'The invoice changed after review. Reopen the action and verify its details.': 285,
  'Bitcoin Retry Timeout': 286,
  'How long Core Lightning keeps retrying a request to Bitcoin before it shuts down. Raise it if Core Lightning stops with "The Bitcoin backend died" while Bitcoin is busy, for example during a reindex.': 287,
  'Tower URI': 288,
  Label: 289,
  'An optional name for this tower, such as who runs it.': 290,
  Watchtowers: 291,
  'Could not list watchtowers: ${error}': 292,
  '${count} of ${total} watchtowers are unreachable or not registered: ${towers}': 293,
  'Retrying ${count} of ${total} watchtowers: ${towers}': 294,
  'All ${total} watchtowers are reachable': 295,
  CLBOSS: 296,
  'CLBOSS must be enabled in Plugins': 297,
  'CLBOSS refused the request: ${error}': 298,
  'CLBOSS Status': 299,
  'Show what CLBOSS currently sees and does: connectivity, its reading of on-chain fees, whether it is managing on-chain funds, the peers you have excluded from management, and the swaps it has made.': 300,
  'CLBOSS returned an unreadable status.': 301,
  Version: 302,
  Internet: 303,
  'On-chain fees': 304,
  'On-chain funds': 305,
  'Ignored until ${time}': 306,
  Managed: 307,
  'Channel candidates': 308,
  'Unmanaged peers': 309,
  None: 310,
  Swaps: 311,
  Count: 312,
  ...
  Received: 314,
  'Lost to fees': 315,
  'Ignore On-chain Funds': 316,
  'Stop CLBOSS from putting on-chain funds into channels of its choosing, so you can open channels or withdraw funds yourself. It keeps managing fees, rebalancing and peers, and resumes on its own when the time runs out.': 317,
  Duration: 318,
  'On-chain funds ignored': 319,
  'CLBOSS will leave on-chain funds alone for ${hours} hours, or until you run Resume On-chain Management.': 320,
  'Resume On-chain Management': 321,
  'Let CLBOSS manage on-chain funds again after Ignore On-chain Funds.': 322,
  'On-chain management resumed': 323,
  'CLBOSS is managing on-chain funds again.': 324,
  'Channel fees': 325,
  'Opening channels': 326,
  'Closing channels': 327,
  Rebalancing: 328,
  'Unmanage Peer': 329,
