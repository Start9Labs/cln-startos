                    ...
                    "variants": {
                      ...
                      "merchant": {
                        ...
                        "lease-fee-basis": {
                          ...
                          "nullable": true,
                          "name":
                            "Fee as Percentage of Requested Funds (basis points)",
                          "description":
        ...
        "plugins": {
          ...
          "spec": {
            ...
            "circular": {
              ...
              "description":
                "Helps routing nodes rebalance their channels in the most efficient way possible.\nCan be called via command line or the Spark console.        \n\nSource: https://github.com/giovannizotta/circular\n",
              "default": false,
            },
            "sparko": {
              "type": "boolean",
              ...
              "description":
                "The famous Spark wallet repackaged as a single-binary lightningd plugin. This works either as a personal wallet with a nice UI (see link above) or as a full-blown HTTP-RPC bridge to your node that can be used to develop apps.        \n\nSource: https://github.com/fiatjaf/sparko\n",
              "default": false,
            },
            "noise": {
              "type": "boolean",
              "name": "Enable Noise Plugin",
              "description":
