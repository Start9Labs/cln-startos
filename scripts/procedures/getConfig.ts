      ...
      experimental: {
        ...
        spec: {
          ...
          "xpay-handle-pay": {
            type: "boolean",
            name: "Xpay",
            description: "Setting this makes xpay intercept simple pay commands. Note that the response will be different from the normal pay command, however. As of Core Lightning 26.06 this is enabled upstream by default, and pay is scheduled to be replaced by xpay entirely in 27.03.  <b>Default: Enabled</b>",
            default: true,
            required: false,
          },
        },
